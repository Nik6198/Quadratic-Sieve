...
[1]https://crypto.stanford.edu/pbc/notes/numbertheory/qr.html quadratic residues
[2]https://blogs.msdn.microsoft.com/devdev/2006/06/19/factoring-large-numbers-with-quadratic-sieve/
[3]http://micsymposium.org/mics_2011_proceedings/mics2011_submission_28.pdf
[4]https://en.wikipedia.org/wiki/Quadratic_sieve
[5]https://www.cs.umd.edu/~gasarch/TOPICS/factoring/fastgauss.pdf Guassian elimination
[6]https://en.wikipedia.org/wiki/Newton%27s_method Newton method for squareroot
"""
...
#single polynomial version of quadratic sieve, given smoothness bound B and sieve interval I
    ...
    #print(root)
    print("Attempting to factor {0}  ...\n".format(N))
    #P,I = size_bound(N)
    
    print("Generating {} -smooth factor base...\n".format(B))
...
print(QS(1811706971,17,10000000)) 